<%-- 
    Document   : Reportes
    Created on : 26 feb 2026, 11:08:28
    Author     : Anderson
--%>
    ...
    <div class="dashboard-container">
        ...
        <div class="header-tech">
            <div class="header-title">
                <img src="<%=request.getContextPath()%>/assets/img/logo_sercoplus.png" alt="Sercoplus" class="logo-img">
                <h2>
        ...
        <div class="report-grid">
            <div class="report-card card-blue">
                <div class="report-label">Hardware en Stock Total</div>
        ...
        <div class="charts-container">
            <div class="chart-box" style="flex: 1.5;">
                <div class="chart-title">
                    ...
                    Top 5 Hardware Más Vendido (Unidades Reales)
                </div>
