            ...
            <div class="flex-col-1-5 d-flex justify-center">
                ...
                <div class="electronic-receipt" id="comprobanteElectronico">
                    ...
                    <div class="receipt-header">
                        <img src="../../../public/admin/img/logo_ferreteriacruz.png" alt="ferreteriacruz" class="receipt-logo" onerror="this.src='https://via.placeholder.com/200x60/ffffff/000000?text=ferreteriacruz'">
                        
                        <div class="company-info">
                            <strong>Ferreteria Cruz S.A.C.</strong><br>
                            RUC: 20546987123 | Av. Garcilaso de la Vega 1348, Lima<br>
                            Teléfono: (01) 555-1234 | soporte@ferreteriacruz.com
                        </div>
                    ...
                    <div class="receipt-footer">
                        ...
                        <div class="barcode">Facturacion-ferreteriacruz</div>
                    </div>
                </div>
