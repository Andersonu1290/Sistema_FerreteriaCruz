    ...
    <div class="login-wrapper">
        <div class="login-container" style="box-shadow: 0 20px 60px rgba(0,0,0,0.8); border-top: 4px solid var(--brand-blue);">
            ...
            <div class="logo-wrapper">
                ...
                <img src="../../../public/admin/img/logo_ferreteriacruz.png" alt="ferreteriacruz" class="logo-login" onerror="this.src='https://via.placeholder.com/250x80/1E1E1E/E63946?text=ferreteriacruz'">
            </div>
